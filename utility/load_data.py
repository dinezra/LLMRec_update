...
class Data(object):
    def __init__(self, path, batch_size):
        ...
        train_file = args.data_path + '/train.json'
        val_file = args.data_path + '/val.json' 
        test_file = args.data_path + '/test.json'
        ...
        text_feats = np.load(args.data_path + '/netflix/text_feat.npy')
